    ...
    return (
        <section id="about" className="py-20 px-6 bg-transparent relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto">
                <div className="bg-white dark:bg-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-xl border-2 border-dark/5 dark:border-white/10 flex flex-col md:flex-row gap-10 items-center">
