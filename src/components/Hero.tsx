    ...
    return (
        <section className="min-h-screen flex flex-col justify-center items-center relative px-6 pt-20">
            ...
            <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center">
                ...
                {/* Availability Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/20 bg-white/60 dark:bg-white/10 backdrop-blur-sm text-primary text-xs font-mono font-bold uppercase tracking-wider mb-6 shadow-sm hover:scale-105 transition-transform cursor-default">
                ...
                {/* Status Badge */}
                <div className="inline-flex items-center gap-2 bg-white/80 dark:bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-green-200 dark:border-green-500/30 shadow-sm mb-8 animate-float">
                ...
                >
                    ...
                    {/* Core DB Icon */}
                    <div className={`relative w-32 h-32 md:w-40 md:h-40 bg-gradient-to-br from-white to-gray-100 dark:from-white/10 dark:to-white/5 rounded-3xl shadow-xl border-4 border-dark dark:border-primary/50 flex items-center justify-center transition-transform ${isHovering ? 'animate-shake' : ''}`}>
                        <Database className={`w-16 h-16 md:w-20 md:h-20 text-dark dark:text-white transition-colors duration-300 ${isHovering ? 'text-alert' : ''}`} />
                    ...
                    {/* Orbiting particles */}
                    <div className="absolute inset-0 border-2 border-dashed border-dark/20 dark:border-white/20 rounded-full w-[160%] h-[160%] top-[-30%] left-[-30%] animate-spin-slow pointer-events-none"></div>
                </div>
